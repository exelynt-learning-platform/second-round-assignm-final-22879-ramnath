...
- **Security**: Manage your API key via `.env` or input field. (Automatically falls back to Demo Mode if quota is exceeded).

## Prerequisites

- Node.js installed.
- An [OpenAI API Key](https://platform.openai.com/api-keys) (Optional for Demo Mode).
...
- **Demo Mode Fallback**: Included to resolve 429 API errors.
